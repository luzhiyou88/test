 ...
 * @version 2016/08/06
 */
public class UserSpGroup extends DataEntity<UserSpGroup> {
	...
	private String leaderName;// 组长名
	private Integer groupNum;// 组内人数
	private Integer joinFlag;// 加入小组标识

	public UserSpGroup() {
		super();
	}

	public UserSpGroup(String id) {
		super(id);
	}
