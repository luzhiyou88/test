 ...
 * @version 2016/08/26
 */
public class SpProject extends DataEntity<SpProject> {
	...
	private Page<SpProject> page;
	
	public SpProject() {
		super();
	}

	public SpProject(String id){
		super(id);
	}
	...
	public Page<SpProject> getPage() {
		return page;
	}

	public void setPage(Page<SpProject> page) {
		this.page = page;
	}
