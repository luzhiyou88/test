 ...
 */
package com.education.classroom.core.users.util;
...
import com.education.classroom.core.security.filter.SystemAuthorizingRealm.Principal;
import com.education.classroom.core.service.BaseService;
import com.education.classroom.core.users.constants.dataScopeConstants;
import com.education.classroom.core.users.dao.AreaDao;
import com.education.classroom.core.users.dao.MenuDao;
import com.education.classroom.core.users.dao.OfficeDao;
...
public class UserUtils {
	...
	public static String dataScopeSql(){
		...
		for(Role role:list){
			if(null != role.getDataScope() && dataScopeConstants.DATA_SCOPE_ALL.equals(role.getDataScope())){
				flag = false;
				break;
			}
			if(null != role.getDataScope() && dataScopeConstants.DATA_SCOPE_MYSELF.equals(role.getDataScope())){
				flag = true;
			}
		}
