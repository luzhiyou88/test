...
import com.education.classroom.modules.gen.dao.GenDataBaseDictDao;
...
public class GenTableService extends BaseService {
	...
	public Page<GenTable> findPage(Page<GenTable> page, Map<String, Object> filters) {
		PageHelper.startPage(page.getPageNo(), page.getPageSize());
		List<GenTable> dicts = genTableDao.findList(filters);
		PageInfo<GenTable> tablePage = new PageInfo<GenTable>(dicts);
		PageUtil.convertPage(tablePage, page);
		return page;
	}
