...
import com.education.classroom.modules.gen.dao.GenSchemeDao;
import com.education.classroom.modules.gen.dao.GenTableColumnDao;
import com.education.classroom.modules.gen.dao.GenTableDao;
import com.education.classroom.modules.gen.entity.GenConfig;
import com.education.classroom.modules.gen.entity.GenScheme;
import com.education.classroom.modules.gen.entity.GenTable;
import com.education.classroom.modules.gen.entity.GenTableColumn;
...
//	private GenTemplateDao genTemplateDao;
	...
	public Page<GenScheme> findPage(Page<GenScheme> schemePage, Map<String,Object> filters) {
		GenUtils.getTemplatePath();
		PageHelper.startPage(schemePage.getPageNo(), schemePage.getPageSize());
		List<GenScheme> schemes = genSchemeDao.findList(filters);
		PageInfo<GenScheme> resultPage = new PageInfo<GenScheme>(schemes);
		PageUtil.convertPage(resultPage, schemePage);
		return schemePage;
	}
