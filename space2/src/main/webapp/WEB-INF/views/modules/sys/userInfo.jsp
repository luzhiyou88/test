...
<head>
	...
	function imgChange(headInput) {
		var headPreview=document.getElementById("img");
...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/info" method="post" enctype="multipart/form-data" class="form-horizontal"><%--
		...
		<div class="control-group">
			...
			<div class="controls">
				<c:if test="${not empty user.id}"><img alt="" src="${user.photo}" style="widht:100px;height:100px;" id="img"></c:if>
				<input type="file" name="file" accept="image/*" id="file1" onchange="imgChange(this)" />
			</div> 
		</div>
	<%-- 	<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="mobile" htmlEscape="false" maxlength="50" class="mobilenum"/>
			</div>
		</div>
		<div class="control-group">
