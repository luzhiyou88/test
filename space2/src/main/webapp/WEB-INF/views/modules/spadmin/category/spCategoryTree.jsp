...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${typeList}" var="tpl">{id:'${tpl.id}', pId:'${not empty tpl.pId?tpl.pId:0}', name:"${tpl.name}", url:"${ctx}/spadmin/category/spCategory/list?id=${tpl.id}", target:"cmsMainFrame"},
		            </c:forEach>];
...
<body>
	<div class="accordion-group">
	    <div class="accordion-heading">
	    	<a style="margin-left:6px;">分类列表</a>
	    	<a href="${ctx}/spadmin/category/spCategory/tree" style="float:right;margin-right:8px;">刷新</a>
	    </div>
