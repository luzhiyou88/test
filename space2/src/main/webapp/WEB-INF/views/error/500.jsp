...
<%@page import="com.education.classroom.core.servlet.Servlets"%>
<%@page import=" com.education.classroom.utils.Exceptions"%>
<%@page import="com.education.classroom.utils.StringUtils"%>
...
<body>
	<div class="container-fluid">
		...
		<div class="errorMessage">
			错误信息：<%=ex == null ? "未知错误." : StringUtils.toHtml(ex
						.getMessage())%>
