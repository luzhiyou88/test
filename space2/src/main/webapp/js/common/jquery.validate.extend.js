...
(function($) {
  ...
  //正整数
    ...
    jQuery.validator.addMethod("zfu", function(value, element) {
    ...
    //课程名唯一性
    jQuery.validator.addMethod("checkLessonName", function(value, element, arg) {
    	var url=ctx+"/spadmin/lesson/spLesson/checkLessonName?id="+arg+"&name="+value;
    	var success;
    	contents_getJsonForNonSync(url, null, "post", function(data){
    		success =  data;
	    	},function(){
	    		success = false;
	    	},null);
    ...
    //路演名唯一性
    jQuery.validator.addMethod("checkRoadshowName", function(value, element, arg) {
    	var url=ctx+"/spadmin/roadshow/checkRoadshowName?id="+arg+"&name="+value;
    	var success;
    	contents_getJsonForNonSync(url, null, "post", function(data){
    		success =  data;
    	},function(){
