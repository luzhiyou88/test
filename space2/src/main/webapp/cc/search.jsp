...
<form action="${ctx}/TaskingController/getSysTaskList" name="searchForm" id="searchForm" method="post">
	...
	<div class="zhong ml5">
		<div class="page_head">
			<h4><em class="icon14 i_01"></em>&nbsp;<span>视频管理</span> &gt; <span>视频搜索</span> </h4>
		</div>
		<!-- /tab1 begin-->
		<div class="mt20">
...
<form method="get" name="searchform" action="/searchvideo.jsp">
	<div>
		...
		<input type="text" name="search_cont" id ="search_cont" size="10"/>
	</div>
	<div>视频分类：
	<%
	...
	<select id="supercategory" onchange="show();">
		...
		%>
		<option value="<%=categoryElement.elementText("id")%>" selected="selected"><%=categoryElement.elementText("name")%></option>
		<%
			}
		%>
	</select>
