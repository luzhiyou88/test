 ...
 **/
	...
	Config.key);
	out.print("第 1 页视频操作 triggerURL:"+triggerURL+"<br/>");
	...
	System.out.println("请求视频数据结束。<a href='videolist.jsp'>返回视频同步列表</a>");
